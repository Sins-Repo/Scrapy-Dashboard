...
import { TranslationBundle, ITranslator } from '@jupyterlab/translation';
/**
...
export declare namespace DirListing {
    ...
    interface IRenderer {
         ...
         */
        updateItemNode(node: HTMLElement, model: Contents.IModel, fileType?: DocumentRegistry.IFileType, translator?: ITranslator): void;
        /**

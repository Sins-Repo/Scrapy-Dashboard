...
export interface ICompletionManager {
     ...
     */
    register(completable: ICompletionManager.ICompletable, renderer?: Completer.IRenderer): ICompletionManager.ICompletableAttributes;
}
/**
...
export declare namespace ICompletionManager {
    ...
    interface ICompletableAttributes {
         ...
         */
        connector: IDataConnector<CompletionHandler.IReply, void, CompletionHandler.IRequest> | CompletionHandler.ICompletionItemsConnector;
    }
    /**

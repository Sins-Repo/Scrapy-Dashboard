...
function Card(kernel, item, launcher, commands, trans, launcherCallback) {
    ...
    return (React.createElement("div", { className: "jp-LauncherCard", title: title, onClick: onclick, onKeyPress: onkeypress, tabIndex: 100, "data-category": item.category || trans.__('Other'), key: Private.keyProperty.get(item) },

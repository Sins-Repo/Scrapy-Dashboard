...
export declare namespace Commands {
     ...
     */
    function addEditingCommandsToSettingsMenu(menu: IMainMenu, commands: CommandRegistry, trans: TranslationBundle): void;
    /**
     ...
     */
    function addEditorViewerToViewMenu(menu: IMainMenu, tracker: WidgetTracker<IDocumentWidget<FileEditor>>, trans: TranslationBundle): void;
    /**

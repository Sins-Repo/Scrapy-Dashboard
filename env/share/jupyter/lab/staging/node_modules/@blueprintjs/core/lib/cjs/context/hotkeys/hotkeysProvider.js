...
exports.HotkeysContext = react_1.createContext === null || react_1.createContext === void 0 ? void 0 : react_1.createContext([
    initialHotkeysState,
    noOpDispatch,
]);
...
var HotkeysProvider = function (_a) {
    ...
    var _c = react_1.useReducer(hotkeysReducer, initialHotkeysState), state = _c[0], dispatch = _c[1];
    var handleDialogClose = react_1.useCallback(function () { return dispatch({ type: "CLOSE_DIALOG" }); }, []);
    var dialog = (_b = renderDialog === null || renderDialog === void 0 ? void 0 : renderDialog(state, { handleDialogClose: handleDialogClose })) !== null && _b !== void 0 ? _b : (react_1.default.createElement(hotkeysDialog2_1.HotkeysDialog2, tslib_1.__assign({}, dialogProps, { isOpen: state.isDialogOpen, hotkeys: state.hotkeys, onClose: handleDialogClose })));
    return (react_1.default.createElement(exports.HotkeysContext.Provider, { value: [state, dispatch] },
        children,
        dialog));
};

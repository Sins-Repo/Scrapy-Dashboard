...
function useHotkeys(keys, options) {
    ...
    var localKeys = react_1.useMemo(function () {
        return keys
    ...
    var globalKeys = react_1.useMemo(function () {
        return keys
            .filter(function (k) { return k.global; })
            .map(function (k) { return ({
            combo: hotkeyParser_1.parseKeyCombo(k.combo),
    ...
    var _b = react_1.useContext(context_1.HotkeysContext), dispatch = _b[1];
    ...
    var handleGlobalKeyDown = react_1.useCallback(function (e) {
    ...
    var handleGlobalKeyUp = react_1.useCallback(function (e) { return invokeNamedCallbackIfComboRecognized(true, hotkeyParser_1.getKeyCombo(e), "onKeyUp", e); }, [globalKeys]);
    var handleLocalKeyDown = react_1.useCallback(function (e) {
        return invokeNamedCallbackIfComboRecognized(false, hotkeyParser_1.getKeyCombo(e.nativeEvent), "onKeyDown", e.nativeEvent);
    }, [localKeys]);
    var handleLocalKeyUp = react_1.useCallback(function (e) {

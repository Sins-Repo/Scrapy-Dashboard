...
export function useHotkeys(keys, options = {}) {
    ...
    const handleGlobalKeyUp = useCallback((e) => invokeNamedCallbackIfComboRecognized(true, getKeyCombo(e), "onKeyUp", e), [globalKeys]);
    const handleLocalKeyDown = useCallback((e) => invokeNamedCallbackIfComboRecognized(false, getKeyCombo(e.nativeEvent), "onKeyDown", e.nativeEvent), [localKeys]);
    const handleLocalKeyUp = useCallback((e) => invokeNamedCallbackIfComboRecognized(false, getKeyCombo(e.nativeEvent), "onKeyUp", e.nativeEvent), [localKeys]);
    useEffect(() => {

...
var PanelStack2 = function (props) {
    ...
    var _c = react_1.useState("push"), direction = _c[0], setDirection = _c[1];
    var _d = react_1.useState(props.initialPanel !== undefined ? [props.initialPanel] : []), localStack = _d[0], setLocalStack = _d[1];
    var stack = props.stack != null ? props.stack.slice().reverse() : localStack;
    if (stack.length === 0) {
        return null;
    }
    var handlePanelOpen = react_1.useCallback(function (panel) {
        var _a;
    ...
    var handlePanelClose = react_1.useCallback(function (panel) {
        var _a;
    ...
    var panels = panelsToRender
        ...
        return (react_1.default.createElement(react_transition_group_1.CSSTransition, { classNames: common_1.Classes.PANEL_STACK2, key: key, timeout: 400 },
            react_1.default.createElement(panelView2_1.PanelView2, { onClose: handlePanelClose, onOpen: handlePanelOpen, panel: panel, previousPanel: stack[index + 1], showHeader: showPanelHeader })));
    })
        .reverse();
    var classes = classnames_1.default(common_1.Classes.PANEL_STACK2, common_1.Classes.PANEL_STACK2 + "-" + direction, props.className);
    return (react_1.default.createElement(react_transition_group_1.TransitionGroup, { className: classes, component: "div" }, panels));
};

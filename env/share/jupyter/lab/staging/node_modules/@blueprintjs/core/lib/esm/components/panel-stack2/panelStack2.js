...
export var PanelStack2 = function (props) {
    ...
    var _c = useState("push"), direction = _c[0], setDirection = _c[1];
    var _d = useState(props.initialPanel !== undefined ? [props.initialPanel] : []), localStack = _d[0], setLocalStack = _d[1];
    var stack = props.stack != null ? props.stack.slice().reverse() : localStack;
    if (stack.length === 0) {
        return null;
    }
    var handlePanelOpen = useCallback(function (panel) {
        var _a;
    ...
    var handlePanelClose = useCallback(function (panel) {
        var _a;

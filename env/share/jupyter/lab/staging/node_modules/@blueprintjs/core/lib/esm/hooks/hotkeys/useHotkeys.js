...
export function useHotkeys(keys, options) {
    ...
    var localKeys = useMemo(function () {
        return keys
    ...
    var globalKeys = useMemo(function () {
        return keys
            .filter(function (k) { return k.global; })
            .map(function (k) { return ({
            combo: parseKeyCombo(k.combo),
    ...
    var _b = useContext(HotkeysContext), dispatch = _b[1];
    useEffect(function () {
    ...
    var handleGlobalKeyDown = useCallback(function (e) {
    ...
    var handleGlobalKeyUp = useCallback(function (e) { return invokeNamedCallbackIfComboRecognized(true, getKeyCombo(e), "onKeyUp", e); }, [globalKeys]);
    var handleLocalKeyDown = useCallback(function (e) {
        return invokeNamedCallbackIfComboRecognized(false, getKeyCombo(e.nativeEvent), "onKeyDown", e.nativeEvent);
    }, [localKeys]);
    var handleLocalKeyUp = useCallback(function (e) {
